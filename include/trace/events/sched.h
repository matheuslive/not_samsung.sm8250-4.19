...
TRACE_EVENT(sched_enq_deq_task,
	...
	TP_fast_assign(
		...
		__entry->cpu_load	= 0; /* cpu_load[] gone with EEVDF */
...
TRACE_EVENT(sched_util_est_task,
	...
	TP_fast_assign(
		...
		__entry->est_ewma		= 0; /* ewma gone with util_est rework */
	),
...
TRACE_EVENT(sched_cpu_util,
	...
	TP_printk("cpu=%d nr_running=%d cpu_util=%ld capacity=%u capacity_orig=%u online=%u",
